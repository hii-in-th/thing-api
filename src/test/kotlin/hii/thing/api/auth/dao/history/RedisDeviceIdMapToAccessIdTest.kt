...
class RedisDeviceIdMapToAccessIdTest {
    private lateinit var server: RedisServer
    lateinit var dao: DeviceIdMapToAccessId
    ...
    fun setUp() {
        ...
        dao = RedisDeviceIdMapToAccessId(setOf(HostAndPort(server.host, server.bindPort)), 30)
    }
}
